...
public class ErrorMessages {
    ...
    public static String STUDENT_ALREADY_ADDED = "Can not add in here due to the Text is not empty";
    public static String ANY_STUDENT_NON_EXISTING = "One of the selected students does not exist in selected Student IDs";

    public static String SAVE_DB_EXCEPTION = "Save To DB Exception";
    public static String CHECK_BOX_BLANK = "Please fill all checkboxs";
